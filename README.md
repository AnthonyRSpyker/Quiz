...
! [first page](FirstQuestion.png);
! [first page with correct prompt](FirstQuestionCorrectPrompt.png);
...
! [second page wiht prompt](SecondQuestionIncorrectPrompt.png;
...
! [third page](ThirdQuestion.png);
! [fourth page](FourthQuestion.png);
! [fifth page] (FifthQuestion.png);
...
! [Enter name](YourScoreScreen.png);

Here the user can enter there name where it is then saved on the high score scree.

! [High score with my score](HighScoreWMyHighScore.png);
! [High score screen without scores](ResetHighScoreScreen.png);
