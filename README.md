...
![first page](images/FirstQuestion.png);
![first page with correct prompt](images/FirstQuestionCorrectPrompt.png);
...
![second page wiht prompt](images/SecondQuestionIncorrectPrompt.png;

On this page, the question was answerd incorrectly and we see that the alert informs the user that the question not answered correctly.  Again in this case the alert is dismissed and the user is brought to the next question.

![third page](images/ThirdQuestion.png);
![fourth page](images/FourthQuestion.png);
![fifth page] (images/FifthQuestion.png);
...
![Enter name](images/YourScoreScreen.png);

Here the user can enter there name where it is then saved on the high score scree.

![High score with my score](images/HighScoreWMyHighScore.png);
![High score screen without scores](images/ResetHighScoreScreen.png);
